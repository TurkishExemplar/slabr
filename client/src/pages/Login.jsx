...
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      console.log('[slabr] Login fetch →', url);
      ...
      console.error('[slabr] Login fetch error:', err.name, err.message);
    ...
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
          ...
          <p className="text-zinc-500 text-sm mb-6">Sign in to your collection</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link to="/forgot-password" className="text-indigo-400 hover:text-indigo-300 text-xs transition">
                  Forgot password?
                </Link>
              </div>
              <input
